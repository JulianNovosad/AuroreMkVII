...
set_target_properties(gemmlowp::eight_bit_int_gemm PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libeight_bit_int_gemm.so"
  IMPORTED_SONAME_RELEASE "libeight_bit_int_gemm.so"
  )

list(APPEND _cmake_import_check_targets gemmlowp::eight_bit_int_gemm )
list(APPEND _cmake_import_check_files_for_gemmlowp::eight_bit_int_gemm "${_IMPORT_PREFIX}/lib/libeight_bit_int_gemm.so" )
