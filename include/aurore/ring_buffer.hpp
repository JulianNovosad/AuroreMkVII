...
class LockFreeRingBuffer {
   ...
   public:
     ...
     */
    LockFreeRingBuffer() noexcept : head_(0), tail_(0), mask_(Size - 1) {
     ...
     */
    static constexpr size_t usable_capacity() noexcept { return Size - 1; }
...
class MPMCRingBuffer {
   ...
   public:
    MPMCRingBuffer() noexcept : head_(0), tail_(0), mask_(Size - 1) {}
