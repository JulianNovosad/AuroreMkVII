...
class SpatialResolver {
   public:
    ...
    TargetVector resolve_fused(float range_mm, const PixelCoord& mipi_px,
    ...
    bool is_in_convergence_zone(const PixelCoord& mipi_px, const PixelCoord& usb_px,
                                float range_mm) const;

    void calibrate_with_known_target(float measured_range_mm, const PixelCoord& mipi_px,
